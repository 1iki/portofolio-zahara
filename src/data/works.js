 ...
 *   date           — period string (month/year range or specific date)
...
export const works = [
...

  {
    ...
    link: null,
    mediaType: "image",
    thumbnail: "/projects/pola-makan-pintar-pompi.webp",
    videoUrl: null,
    externalUrl: null,
    organization: "Politeknik Negeri Media Kreatif",
    description:
...

  {
    ...
    mediaType: "tiktok",
    thumbnail: "/projects/conitycast.svg",
...

  {
    ...
    mediaType: "drive",
    thumbnail: "/projects/liputan-weekinshop.svg",
    thumbnailType: "project_artwork",
    ...
    organization: null,
    description: "Peliputan langsung di lapangan untuk event Weekinshop dengan format video vertikal (1080x1920).",
    output: null,
    type: "news",
    featuredEpisode: null,
    source: "PDF",
...

  {
    ...
    organization: "Polimedia TV",
    description:
      "Berperan sebagai reporter yang melakukan peliputan langsung di lapangan, menyajikan berita sesuai kondisi dan fakta. Bertugas melakukan riset, wawancara, serta menulis naskah berita secara informatif untuk distribusi melalui Instagram dan YouTube.",
    output: null,
    type: "news",
    featuredEpisode: null,
    source: "PDF+LinkedIn",
